        ...
        <div class="bott" data-spy="affix" data-offset-top="250" data-offset-bottom="200">
            ...
            <div class="collapse navbar-collapse" id="firstmenu">
                ...
                <ul class="menu-list">
                    ...
                    <li class="first-itm">
                        <a class="smooth-line-up" href="#line-up">Line-up 2018</a>
                    </li>
                    <!--
                                            <li class="first-itm">
                                                <a href="#!">shop</a> https://huckfinnjubilee201.wixsite.com/shop
                                            </li>
                    -->
                    <li class="first-itm">
                        <a href="#">EVENT INFO</a>
                        <div class="second-lvl-menu">
                            <a href="/map">MAP</a>
                            <a href="/MeetTheHUCKERS">MEET THE HUCKERS</a>
                            <a href="/TRAVEL">TRAVEL & ACCOMMODATIONS</a>
                            <a href="/CampingAndParking">CAMPING & PARKING</a>
